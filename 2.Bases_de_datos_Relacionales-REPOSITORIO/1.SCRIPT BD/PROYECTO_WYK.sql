...
(
    TIPO_ACCESO ENUM('EMPLEADO','ADMINISTRADOR') NOT NULL,
	ID_USUARIO_FK_US_EMPLE INT PRIMARY KEY,
    FOREIGN KEY (ID_USUARIO_FK_US_EMPLE) REFERENCES USUARIO(ID_USUARIO),
    ID_EMPLEADO_FK_US_EMPLE INT UNIQUE NOT NULL,
    FOREIGN KEY (ID_EMPLEADO_FK_US_EMPLE) REFERENCES EMPLEADO(ID_EMPLEADO)
);

CREATE TABLE USUARIO_CLIENTE 
(
    ID_USUARIO_FK_US_CLIENTE INT PRIMARY KEY,
    FOREIGN KEY (ID_USUARIO_FK_US_CLIENTE) REFERENCES USUARIO(ID_USUARIO),
    ID_CLIENTE_FK_US_CLIENTE INT UNIQUE NOT NULL,
    FOREIGN KEY (ID_CLIENTE_FK_US_CLIENTE) REFERENCES CLIENTE(ID_CLIENTE)
);
